...
//       }
// }
int customers(int *coaches, int *waiting_room, int *first,sem_t *sema,sem_t *mutex, int *allocationTable){
...
int main(){
    ...
    for(int i = 0; i < 18; i++){
        ...
        if(pid == 0){
            ...
            customers(coaches,waiting_room, first, sema, mutex, allocationTable);
